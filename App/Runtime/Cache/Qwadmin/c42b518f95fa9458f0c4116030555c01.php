                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form class="form-horizontal" id="form" method="post" action="<?php echo U('update');?>">
                            ...
                            <input type="hidden" name="id" value="<?php echo ($banner["id"]); ?>" id="aid"/>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <select id="sid" name="sid" class="col-xs-10 col-sm-5">
                                        ...
                                        <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $banner['sid']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="col-xs-10 col-sm-5">
                                        <?php echo UpImage("image_path",100,100,$banner['image_path']);?>
                                    </div>
                                    <span class="help-inline col-xs-12 col-sm-7">
