    ...
    <div class="main-content">
        ...
        <ul class="breadcrumb">
            ...
            <?php if(isset($current['ptitle'])): ?><li>
                    <a href="<?php echo U($current['pname']);?>"><?php echo ($current['ptitle']); ?></a>
                </li><?php endif; ?>
                        ...
                        <div class="cf">
                            <form class="form-inline" action="" method="get">
                                ...
                                <select name="sid" class="form-control">
                                    ...
                                    <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo['id'] == $latest['sid']): ?>selected<?php endif; ?>><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                        ...
                        <form id="form" method="post" action="<?php echo U('del');?>">
                            <table class="table table-striped table-bordered">
                                ...
                                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td class="text-center"><a href="<?php echo U('index',array('sid'=>$val['sid']));?>" title="<?php echo ($val['name']); ?>"><?php echo ($val['name']); ?></a>
                                        </td>
                                        <td class="text-center"><?php echo ($val['title']); ?></td>
                                        <td class="text-center"><?php echo (date("Y-m-d H:i:s",$val['t'])); ?></td>
                                        <td class="text-center"><a href="<?php echo U('edit',array('id'=>$val['id']));?>"><i
        ...
        <div class="footer-inner">
            ...
            <div class="footer-content">
                            <span class="bigger-120">
                                <small><?php echo (C("footer")); ?> <?php echo (C("footer-address")); ?></small>
                            </span>
            </div>
